...
import com.demo.rbacDemo.common.Consts;
...
public class UserPrincipal implements UserDetails {
    ...
    public static UserPrincipal create(User user, List<Role> roles, List<Permission> permissions) {
        ...
        return new UserPrincipal(user.getId(), user.getUserName(), user.getPassWord(), user.getRealName(), user.getPhone(), user.getEmail(), user.getStatus(),user.getCreateTime(),user.getUpdateTime(), roleNames, authorities);
    }
