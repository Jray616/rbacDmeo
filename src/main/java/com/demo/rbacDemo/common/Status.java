package com.demo.rbacDemo.common;
...
public enum Status implements IStatus {
     ...
     * 未找到字典数据！
     */
    DICT_NOT_FOUND(4001, "未找到字典数据！"),

    /**
     * 未找到有害言论！
     */
    HARMFUL_SPEECH_NOT_FOUND(4002,"未找到有害言论！"),
     ...
     * 未找到消息发送方式！
     */
    MESSAGE_MODLE_ERROR(6001, "未找到消息发送方式！"),


    /**
     * 数据中心响应异常
     */
    DATA_ERROR(7001,"数据中心响应异常"),

    /**
     * 数据中心数据库连接异常
     */
    DATA_CONNECTION_ERROR(7002,"数据中心数据库连接异常"),

    /**
     * 中控平台响应数据解析异常
     */
    RESPONSE_DISPOSE_ERROR(6002, "中控平台响应数据解析异常"),;
